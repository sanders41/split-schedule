...
The best place to start is to check the [issues](https://github.com/sanders41/split-schedule/issues) for something that interests you.
...
```sh
git clone https://github.com/your-user-name/split-schedule.git
cd split-schedule
git remote add upstream https://github.com/sanders41/split-schedule.git
```

This creates the directory split-schedule and connects your repository to the upstream (main project) repository.
...
split-schedule uses [isort](https://pycqa.github.io/isort/),
...
```sh
# Run isort
isort split_schedule tests

# Run black
black split_schedule tests

# Run flake8
flake8 split_schedule test
...
[main github page](https://github.com/sanders41/split-schedule). You can run tests and see the
code coverage by running.

```sh
pytest --cov=split_schedule
```

In additon to mainting the coverage percentage please ensure that all
tests are passing before submitting a pull request.

tox can be used to run both linting, and run the tests in all versions of Python split-schedule supports. Note that you will need to have all the verions of Python installed for this to work.
...
After pushing your code to origin it is now on GitHub but not yet part of the split-schedule project. When you’re ready to ask for a code review, file a pull request. Before you do, once again make sure that you have followed all the guidelines outlined in this document regarding code style, tests, and documentation. You should also double check your branch changes
...
If everything looks good, you are ready to make a pull request. This is how you let the maintainers of the split-schedule project know you have code ready to be reviewed. To submit the pull request:
